<template>
  <div class="calculator">
    ...
    <div class="input">
      ...
      <select name="item-rental-period" id="item-rental-period-select" v-model="rentalPeriodInDays">
      ...
      <!--TODO: add euro symbol to left-hand side-->
      <p>Indicate the minimum rental period for your item. More extended periods have a lower daily price. However, since it has a more extended period, the booking value is higher. You make more per booking, and you'll earn the item's RRP sooner.</p>
    </div>
    <div class="output">
